...
var (
	userColumns               = []string{"id", "email", "password", "display_name", "picture", "token_version", "role", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"email", "password", "display_name", "picture", "token_version", "updated_at"}
	userColumnsWithDefault    = []string{"id", "role", "created_at"}
